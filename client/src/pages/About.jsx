  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      ...
      <p className="mb-4 text-slate-700">
        ...
        Whether you are looking to buy, sell, or invest, our team of dedicated
        professionals is here to guide you through every step of the process.
        With years of experience in the industry and an in-depth understanding
      ...
      <p className="mb-4 text-slate-700">
        ...
        start, and a stepping stone towards your future. That’s why we take the
        time to listen to your needs, understand your goals, and work tirelessly
        to achieve them. Our comprehensive range of services includes
        residential and commercial property sales, property management, and
      ...
      <p className="mb-4 text-slate-700">
        ...
        and up-to-date information. We are proud to have built a reputation for
        integrity, transparency, and client satisfaction. When you choose Ankit
        Estate, you are not just choosing a real estate agency; you are choosing
